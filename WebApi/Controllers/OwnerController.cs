...
namespace WebApi.Controllers
{
    ...
    public class OwnerController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> AddAsync([FromBody] OwnerDto model)
        {
            try
            {
                return StatusCode(ResponseHttpMessageEnum.Ok.StatusCode,
                        ResponseHelper<OwnerDto>.AddResponse(
        ...
        public async Task<IActionResult> GetAllAsync()
        {
            try
            {
                ...
                return StatusCode(ResponseHttpMessageEnum.Ok.StatusCode,
                        ResponseHelper<IList<OwnerDto>>.AddResponse(
                            result: result,
                            success: ResponseHttpMessageEnum.Ok.Success,
                            statusCode: ResponseHttpMessageEnum.Ok.StatusCode,
                            message: ResponseHttpMessageEnum.Ok.Message
        ...
        public async Task<IActionResult> GetPagedAsync([FromQuery] int page, [FromQuery] int take)
        {
            try
            {
                ...
                return StatusCode(ResponseHttpMessageEnum.Ok.StatusCode,
                        ResponseHelper<DataCollection<OwnerDto>>.AddResponse(
                            result: result,
                            success: ResponseHttpMessageEnum.Ok.Success,
                            statusCode: ResponseHttpMessageEnum.Ok.StatusCode,
                            message: ResponseHttpMessageEnum.Ok.Message
        ...
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateAsync(Guid id, [FromBody] OwnerDto model)
        {
            if (model.Id != id)
            {
