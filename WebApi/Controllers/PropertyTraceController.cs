...
namespace WebApi.Controllers
{
    ...
    public class PropertyTraceController : ControllerBase
    {
        ...
        /// <returns>PropertyTrace</returns>
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status401Unauthorized)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        [HttpPost]
        public async Task<IActionResult> AddAsync([FromBody] PropertyTraceDto model)
        {
            try
            {
                return StatusCode(ResponseHttpMessageEnum.Ok.StatusCode,
                        ResponseHelper<PropertyTraceDto>.AddResponse(
        ...
        public async Task<IActionResult> GetAllAsync()
        {
            try
            {
                ...
                return StatusCode(ResponseHttpMessageEnum.Ok.StatusCode,
                        ResponseHelper<IList<PropertyTraceDto>>.AddResponse(
                            result: result,
                            success: ResponseHttpMessageEnum.Ok.Success,
                            statusCode: ResponseHttpMessageEnum.Ok.StatusCode,
                            message: ResponseHttpMessageEnum.Ok.Message
        ...
        public async Task<IActionResult> GetPagedAsync([FromQuery] int page, [FromQuery] int take)
        {
            try
            {
                ...
                return StatusCode(ResponseHttpMessageEnum.Ok.StatusCode,
                        ResponseHelper<DataCollection<PropertyTraceDto>>.AddResponse(
                            result: result,
                            success: ResponseHttpMessageEnum.Ok.Success,
                            statusCode: ResponseHttpMessageEnum.Ok.StatusCode,
                            message: ResponseHttpMessageEnum.Ok.Message
        ...
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateAsync(Guid id, [FromBody] PropertyTraceDto model)
        {
            if (model.Id != id)
            {
